                ...
                <div class="card-header border-0 pb-1">
                    <div class="card-header-title">
                        <div class="d-flex justify-content-between">
                            <h4>All Faculties</h4>
                            <a href="{{ route('faculty.add')}}" class="btn btn-primary">Add Faculty</a>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div>
                        <div class="table-responsive table-desi">
                            <table id="faculties-table" class="table table-striped all-package">
                                <thead>
                                    <tr>
                                        <th>S/No</th>
                                        <th>Faculty Name</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <form method="POST" action="{{ route('faculty.delete', $faculty->id)}}" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="">
                                                                <button type="submit"
