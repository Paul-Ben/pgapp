                                ...
                                <form method="POST" action="{{ route('department.update', $department->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <label class="form-label-title col-sm-2 mb-4">Department Name</label>
                                            <div class="col-sm-4 mb-4">
                                                <input class="form-control" value="{{ $department->name }}" name="name" type="text"
                                                    placeholder="Faculty Name" required>
                                            </div>
                                            <label class="form-label-title col-sm-2 mb-4">Department Code</label>
                                            <div class="col-sm-4 mb-4">
                                                <input class="form-control" value="{{ $department->code }}" name="code" type="text"
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-4 mb-4">
                                                <select class="form-control" name="faculty_id" required>
                                                    <option value="{{ $department->faculty_id }}" selected>{{$department->faculty->name}}</option>
