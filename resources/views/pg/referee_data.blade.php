                    ...
                    <div class="col-sm-12">
                        @if ($count < 1)
                            <div class="alert alert-danger">
                                <strong>Alert!</strong> You have not added any referees yet. Please add at least two referees to proceed.
                            </div>
                            <div class="card">
                            <div class="card-body">
                                <div class="card-header-2">
                                    <h5>A. First Referee Information</h5>
                                    @if (session('success'))
                                ...
                                <form method="POST" action="{{ route('referees.store') }}" class="theme-form theme-form-2 mega-form">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-4 mb-4">
                                                <input class="form-control" name="rank" type="text" placeholder="Rank" required>
                                            </div>
                        ...
                        @if ($count == 1)
                            <div class="alert alert-success">
                                <strong>Success!</strong> You have added one referee. Please add one more referee to proceed.
                            </div>
                            <div class="card">
                            <div class="card-body">
                                <div class="card-header-2">
