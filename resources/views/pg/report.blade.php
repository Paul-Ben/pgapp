    ...
    <div class="container">
        ...
        <section class="details-section">
            ...
            <div class="details-grid personal-details-grid">
                ...
                <div class="detail-item"><span class="detail-label">Date of Birth:</span>
                    {{ $applicant->date_of_birth }}</div>
                <div class="detail-item"><span class="detail-label">Phone No:</span> {{ $applicant->phone_no }}</div>
                <div class="detail-item"><span class="detail-label">Email Address:</span>
                    {{ $applicant->email_address }}</div>
                <div class="detail-item"><span class="detail-label">Nationality:</span> {{ $applicant->country }}</div>
                <div class="detail-item"><span class="detail-label">State:</span> {{ $applicant->state_of_origin }}
                </div>
                <div class="detail-item"><span class="detail-label">LGA:</span> {{ $applicant->lga }}</div>
                <div class="detail-item detail-full-width"><span class="detail-label">Contact
                        Address:</span>{{ $applicant->contact_address }}</div>
            </div>
        </section>
        ...
        <section class="details-section">
            ...
            <div class="details-grid course-details-grid">
                <div class="detail-item"><span class="detail-label">Course Applied:</span>
                    {{ $applicant->first_choice }}</div>
                <div class="detail-item"><span class="detail-label">Department:</span> {{ $applicant->department }}
                </div>
                ...
                <div class="detail-item"><span class="detail-label">Highest Qualification:</span>
                    {{ $applicant->qualification }}</div>
            </div>
        </section>
                    ...
                    @foreach ($referees as $referee)
                        <tr>
                            ...
                            <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="6b010a050e451806021f032b0e130a061b070e450e0f1e">{{ $referee->email_address }}</a>
                            </td>
        ...
        <section class="certification-section">
            ...
            <p class="certification-status">
                ...
                <label for="credentialsSubmitted">I hereby certify that all required credentials have been submitted and
                    are true to the best of my knowledge.</label>
            </p>
