                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center py-5">
                                    ...
                                    <h3 class="mb-3">Reference Submitted Successfully</h3>
                                    <p class="mb-4">We appreciate you taking the time to provide a reference for {{ $applicant->fullname }}.</p>
                                    ...
                                    <div class="alert alert-info mx-auto" style="max-width: 600px;">
                                        ...
                                        <p><strong>Date Submitted:</strong> {{ now()->format('F j, Y \a\t g:i a') }}</p>
                                    </div>
